...
"use strict";var Modal=_dereq_("./modal"),Utils=_dereq_("./utils"),ouibounce=_dereq_("ouibounce"),MauticSubscribeModal=function(a,i){var o=i&&i.submittingMessage||"Please wait...",e=i&&i.ouibounce||{aggressive:!0,timer:0},t=i&&i.mauticFormId,n=i&&i.onSubmit,d=i&&i.mauticDomain,u=Modal(a,{dialogClass:"modal-dialog",backdropClass:"modal-backdrop"});if("undefined"==typeof window.MauticSDKLoaded){Utils.addEvent(window,"load",function(){window.MauticSDK.onLoad()}),window.MauticSDKLoaded=!0,window.MauticDomain=d,window.MauticLang={submittingMessage:o};var c=document.getElementsByTagName("head")[0],l=document.createElement("script");l.type="text/javascript",l.src=d+"/media/js/mautic-form.js",c.appendChild(l)}if(t){"undefined"==typeof window.MauticFormCallback&&(window.MauticFormCallback={}),"undefined"==typeof window.MauticFormCallback[t]&&(window.MauticFormCallback[t]={});var r=window.MauticFormCallback[t].onResponse;window.MauticFormCallback[t].onResponse=function(){r&&r.apply(this,arguments),n&&n(),u.hide()}}return ouibounce(u,e)};module.exports=MauticSubscribeModal;
